...
class StructuredLoggerTest {
  ...
  void representativeRequestLineHasStableNamesAndTypes() throws Exception {
    ...
    telemetry.markSuccess(31, "REVIEW");

    String line = logger.serialize(logger.createRequestEvent(telemetry, 200, 42, "POST"));
  ...
  void errorEventContainsAParseableSanitizedJavaStack() throws Exception {
    ...
    JsonNode event =
        objectMapper.readTree(
            logger.serialize(logger.createRequestEvent(telemetry, 503, 12, "POST")));
